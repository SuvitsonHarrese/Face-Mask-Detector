...
# 1st photo
img_1 = Image.open(r"detection_img\1.jpg")
...
# 2nd photo
img_2 = Image.open(r"detection_img\2.jpg")
...
# image
Covid19_img = PhotoImage(file ='C:\Python Programs\Tkinker programs\detection_img\covid-19-14.png')
Omricon_img = PhotoImage(file ='C:\Python Programs\Tkinker programs\detection_img\omicron-3.png')
DeltaVirus_img = PhotoImage(file ='C:\Python Programs\Tkinker programs\detection_img\deltav-2.png')
...
#3rd photo
img_3 = Image.open(r"detection_img\4.jpg")
...
# image
ImageDetect_img = PhotoImage(file ='C:\Python Programs\Tkinker programs\detection_img\Image Detection2.png')
VideoDetect_img = PhotoImage(file ='C:\Python Programs\Tkinker programs\detection_img\Video Detection4.png')
...
lb1 = Label(frame5,text="We the student of Fr.C.R.I.T, Vashi , Branch: Computer Science (2020 batch) had immense pleasure of getting this opportunity of making “Face Mask Detector, we came up with the idea of making face mask detector, as it is not",font = ("times 35",10))
lb1.place(x=25,y = 50)
